...
def get_image_from_data_url( data_url, resize=True, base_width=28, base_height=28 ):
    ...
    # resizing the image
    # for us it is required as MNIST dataset pictures are of 28x28 format
    # so our inpit layer of CNN will have a 28x28 = 
    if resize:
